...
class Solution:
    def maxSumBST(self, root):
        ...
        self.ans = 0
        def dp(node):
            """Calculate the maximum sum using an input node.
            
            @returns
                bst_sum: int  - Maximum sum.
                is_bst:  bool - Subtree, including an input node, is BST or not BST.
                min_val: int  - Minimum value of subtree including an input node
                max_val: int  - Maximum value of subtree including an input node
